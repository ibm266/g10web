  ...
  return (
    <SessionPage
      config={{
        ...
        intro:
          "Treat yourself to a stunning solo photoshoot in Aruba. You choose the location — beach, desert-scape, or somewhere in between — and I'll handle the rest with pro edits included.",
